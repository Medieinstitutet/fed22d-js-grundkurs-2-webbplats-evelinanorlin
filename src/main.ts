...
// TODO
// - MENY -> ska förvinna när man scrollar ner och
// synas när man skrollar upp. mobil-menyn ska ploppa upp när man trycker
// på burgern. samt lägga in animationer när menyer försvinner/dyker upp
...
// en pop-up med mer info om event
